...
def remove_peer():
    peer_key = 'c192da83862df8075a36226a2eda4f92ea0ab11af36ec475fed6e414faf79d42'
    tx = iroha.transaction([iroha.command('RemovePeer', public_key=peer_key)], creator_account=ADMIN_ACCOUNT_ID, quorum=1)
